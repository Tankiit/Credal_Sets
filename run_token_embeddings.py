...
class TokenEmbeddingProcessor:
    ...
    def extract_token_embeddings(self, texts, layer=None, layers=None, pooling='cls'):
        ...
        if layers is not None:
            ...
            print(f"Extracting from multiple layers: {target_layers}")
        ...
        print(f"Target layers: {target_layers}, Pooling: {pooling}")
        ...
        with torch.no_grad():
            ...
            if hasattr(dummy_outputs, 'hidden_states'):
                ...
                print(f"Model has {num_layers} transformer layers (plus input embeddings)")
                ...
                for l in target_layers:
                    if l == -1:
                        ...
                        print(f"Warning: Layer {l} is out of range (0-{num_layers}). Using last layer instead.")
        ...
        if len(target_layers) > 1:
            print(f"Combined {len(target_layers)} layers: embedding_dim = {final_embeddings.shape[1]}")
